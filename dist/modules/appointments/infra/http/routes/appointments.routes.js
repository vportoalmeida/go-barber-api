...
var _AppointmentDeleteController = _interopRequireDefault(require("../controllers/AppointmentDeleteController"));
...
const appointmentDeleteController = new _AppointmentDeleteController.default();
...
appointmentsRouter.post('/delete', (0, _celebrate.celebrate)({
  [_celebrate.Segments.BODY]: {
    provider_id: _celebrate.Joi.string().uuid().required(),
    date: _celebrate.Joi.date()
  }
