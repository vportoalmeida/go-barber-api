...
let CreateAppointmentService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if ((0, _dateFns.isBefore)(appointmentDate, Date.now())) {
      throw new _AppError.default(`You can'y create an appointment on past date.`);
    }

    if (user_id === provider_id) {
      throw new _AppError.default(`You can'y create an appointment with yourself.`);
    }

    if ((0, _dateFns.getHours)(appointmentDate) < 8 || (0, _dateFns.getHours)(appointmentDate) > 17) {
      throw new _AppError.default(`You can'y only create appointments between 8am and 5pm`);
    }
